...
func TestReplaceAllRangesByFunc_ok(t *testing.T) {
	...
	var cases = []struct {
		...
		{`next sun`, nextWeekdayFrom(now, time.Sunday)},
		{`next mon`, nextWeekdayFrom(now, time.Monday)},
		{`next tue`, nextWeekdayFrom(now, time.Tuesday)},
		{`next wed`, nextWeekdayFrom(now, time.Wednesday)},
		{`next thu`, nextWeekdayFrom(now, time.Thursday)},
		{`next fri`, nextWeekdayFrom(now, time.Friday)},
		{`next sat`, nextWeekdayFrom(now, time.Saturday)},

		// months
		{`Last january`, lastSpecificMonth(now, time.January)},
		{`Last february`, lastSpecificMonth(now, time.February)},
		{`Last march`, lastSpecificMonth(now, time.March)},
		{`Last april`, lastSpecificMonth(now, time.April)},
		{`Last may`, lastSpecificMonth(now, time.May)},
		{`Last june`, lastSpecificMonth(now, time.June)},
		{`Last july`, lastSpecificMonth(now, time.July)},
		{`Last august`, lastSpecificMonth(now, time.August)},
		{`Last september`, lastSpecificMonth(now, time.September)},
		{`Last october`, lastSpecificMonth(now, time.October)},
		{`Last november`, lastSpecificMonth(now, time.November)},
		{`Last december`, lastSpecificMonth(now, time.December)},

		{`Next january`, nextSpecificMonth(now, time.January)},
		{`Next february`, nextSpecificMonth(now, time.February)},
		{`Next march`, nextSpecificMonth(now, time.March)},
		{`Next april`, nextSpecificMonth(now, time.April)},
		{`Next may`, nextSpecificMonth(now, time.May)},
		{`Next june`, nextSpecificMonth(now, time.June)},
		{`Next july`, nextSpecificMonth(now, time.July)},
		{`Next august`, nextSpecificMonth(now, time.August)},
		{`Next september`, nextSpecificMonth(now, time.September)},
		{`Next october`, nextSpecificMonth(now, time.October)},
		{`Next november`, nextSpecificMonth(now, time.November)},
		{`Next december`, nextSpecificMonth(now, time.December)},

		{"Last jan", lastSpecificMonth(now, time.January)},
		{"Last feb", lastSpecificMonth(now, time.February)},
		{"Last mar", lastSpecificMonth(now, time.March)},
		{"Last apr", lastSpecificMonth(now, time.April)},
		{"Last may", lastSpecificMonth(now, time.May)},
		{"Last jun", lastSpecificMonth(now, time.June)},
		{"Last jul", lastSpecificMonth(now, time.July)},
		{"Last aug", lastSpecificMonth(now, time.August)},
		{"Last sep", lastSpecificMonth(now, time.September)},
		{"Last oct", lastSpecificMonth(now, time.October)},
		{"Last nov", lastSpecificMonth(now, time.November)},
		{"Last dec", lastSpecificMonth(now, time.December)},

		{"Next jan", nextSpecificMonth(now, time.January)},
		{"Next feb", nextSpecificMonth(now, time.February)},
		{"Next mar", nextSpecificMonth(now, time.March)},
		{"Next apr", nextSpecificMonth(now, time.April)},
		{"Next may", nextSpecificMonth(now, time.May)},
		{"Next jun", nextSpecificMonth(now, time.June)},
		{"Next jul", nextSpecificMonth(now, time.July)},
		{"Next aug", nextSpecificMonth(now, time.August)},
		{"Next sep", nextSpecificMonth(now, time.September)},
		{"Next oct", nextSpecificMonth(now, time.October)},
		{"Next nov", nextSpecificMonth(now, time.November)},
		{"Next dec", nextSpecificMonth(now, time.December)},
		...
		//{"March 31", truncateMonth(time.Date(2022, 3, 31, 0, 0, 0, 0, now.Location()))},
		{"January, 2017", truncateMonth(time.Date(2017, 1, 1, 0, 0, 0, 0, now.Location()))},
		{"Jan, 2017", truncateMonth(time.Date(2017, 1, 1, 0, 0, 0, 0, now.Location()))},
