...
func lastThisNextStrToRange(normSrc string, now time.Time) (Range, bool) {
	...
	// this $longWeekday
	case "this monday":
		return thisWeekdayFrom(now, time.Monday), true
	case "this tuesday":
		return thisWeekdayFrom(now, time.Tuesday), true
	case "this wednesday":
		return thisWeekdayFrom(now, time.Wednesday), true
	case "this thursday":
		return thisWeekdayFrom(now, time.Thursday), true
	case "this friday":
		return thisWeekdayFrom(now, time.Friday), true
	case "this saturday":
		return thisWeekdayFrom(now, time.Saturday), true
	case "this sunday":
		return thisWeekdayFrom(now, time.Sunday), true
	...
	// next $longWeekday
	case "next monday":
		return nextWeekdayFrom(now, time.Monday), true
	case "next tuesday":
		return nextWeekdayFrom(now, time.Tuesday), true
	case "next wednesday":
		return nextWeekdayFrom(now, time.Wednesday), true
	case "next thursday":
		return nextWeekdayFrom(now, time.Thursday), true
	case "next friday":
		return nextWeekdayFrom(now, time.Friday), true
	case "next saturday":
		return nextWeekdayFrom(now, time.Saturday), true
	case "next sunday":
		return nextWeekdayFrom(now, time.Sunday), true
